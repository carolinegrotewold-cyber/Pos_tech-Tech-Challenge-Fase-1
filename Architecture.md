...
Scraper baixa e parseia os livros (título, preço, disponibilidade, rating, categoria, imagem).
Dados são salvos em data/books.csv.
API lê o CSV sob demanda e expõe endpoints REST.
JWT protege a rota administrativa de re-scraping.
